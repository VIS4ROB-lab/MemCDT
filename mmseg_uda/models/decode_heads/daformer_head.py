...
# Modifications:
# - Add SelfAttentionBlock and ISALayer implementation for compatibility with
#   mmsegmentation >= 0.16.0.
# - Do not pass decoder_params to super().__init__() for compatibility with
#   mmsegmentation's BaseDecoder.
...
from mmseg.models.decode_heads.sep_aspp_head import DepthwiseSeparableASPPModule  # noqa
...
class DAFormerHead(BaseDecodeHead):
    ...
    def __init__(self, decoder_params=None, **kwargs):
        ...
        assert decoder_params is not None
