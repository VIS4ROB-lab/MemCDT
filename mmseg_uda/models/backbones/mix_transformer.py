...
# Modifications:
#   - Rename MixVisionTransformer to NVMixVisionTransformer to distinguish the
#     original implementation from the one in mmsegmentation >= 0.16.0.
...
class NVMixVisionTransformer(BaseModule):
...
@BACKBONES.register_module()
class mit_b0(NVMixVisionTransformer):
...
@BACKBONES.register_module()
class mit_b1(NVMixVisionTransformer):
...
@BACKBONES.register_module()
class mit_b2(NVMixVisionTransformer):
...
@BACKBONES.register_module()
class mit_b3(NVMixVisionTransformer):
...
@BACKBONES.register_module()
class mit_b4(NVMixVisionTransformer):
...
@BACKBONES.register_module()
class mit_b5(NVMixVisionTransformer):
